      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        <DialogHeader>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-">
            ...
            {transaction.is_fraud_inference === 1 ? (
              ...
              <TabsContent value="location">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <div className="min-h-[300px] flex items-center justify-center border rounded-md bg-muted/50">
                      {!mapVisible ? (
                        ...
                        <LocationMap
                          ...
                          isFraud={transaction.is_fraud_inference === 1}
                        />
                      )}
                    </div>
                    </div>
